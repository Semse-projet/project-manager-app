...
export const ADMIN_MODULES: AdminModule[] = [
  ...
  },
  {
    ...
    status: "operational",
    metric: { label: "Active", value: "1", tone: "success" },
    children: [
      { id: "agro", label: "Agro / FarmOps", href: "/agro", description: "Full farm management: animals, tasks, inventory, health, feeding, costs, analytics, and reproduction.", status: "operational" },
      { id: "construction", label: "Construction", href: "/admin/field-ops", description: "Field operations, crews, evidence, milestones, and change orders.", status: "operational" },
      { id: "vision-ai", label: "Vision AI", href: "/admin/vision", description: "Material and safety analysis powered by OpenCV and Ollama.", status: "operational" },
