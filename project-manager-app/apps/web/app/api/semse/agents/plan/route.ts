...
export async function POST(request: NextRequest) {
  try {
    ...
    const resp = await fetch(`${API}/v1/agents/semse/buildops/plan`, { method: "POST", headers: { "content-type": "application/json", ...(await buildAuthorizedHeaders(cfg)) }, body: JSON.stringify(body) });
