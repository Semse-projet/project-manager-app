...
export async function POST(request: NextRequest) {
  try {
    ...
    const resp = await fetch(`${API}/v1/agents/semse/protools/estimate`, { method: "POST", headers: { "content-type": "application/json", ...buildSemseRequestHeaders(cfg) }, body: JSON.stringify(body) });
