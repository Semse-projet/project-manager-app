...
const VERTICALS = [
  ...
  },
  {
    ...
    description: "Residential, commercial, and move-in/out cleaning — checklists, crew assignment, and quality photos.",
    href: "/admin/verticals/cleaning",
  ...
  },
  {
    id: "maintenance",
    name: "Maintenance",
    description: "Preventive and corrective property maintenance — electrical, plumbing, HVAC, roofing, and inspections.",
    href: "/admin/verticals/maintenance",
    status: "planned" as const,
    stats: [
