...
export function LaborToolClient({ section }: { section: LaborSection }) {
  ...
  function renderSection(): ReactNode {
    switch (section) {
      ...
      case "materials": return <Card className="p-6"><h3 className="mb-4 font-semibold">Labor Schedule</h3><p className="text-sm text-muted">Total hours: {input.hours} • Base rate: {formatCurrency(BASE_RATES[input.laborType])} • Benefits: {input.benefits ? "Yes" : "No"}</p></Card>;
