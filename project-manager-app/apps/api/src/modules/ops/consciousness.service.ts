...
const MODULE_REGISTRY: Array<{
  ...
  { name: "Prometeo RAG",      hasBackend: true,  hasFrontend: true,  hasTests: true,  hasSSE: false, hasRAG: true,  hasAudit: false, hasPermissions: true,  notes: ["Fases 0-5 + Fase 5 feedback", "42 docs 201 chunks hybrid", "Trade guide 13 trades", "Prometeo Agent conectado"] },
  ...
  { name: "Finance",           hasBackend: true,  hasFrontend: true,  hasTests: true,  hasSSE: true,  hasRAG: false, hasAudit: false, hasPermissions: true,  notes: ["Invoices", "Expenses", "PDF export", "Finance Hub", "OCR receipt parsing", "29 tests unitarios FIN.*"] },
  ...
  { name: "Contractors / CRM", hasBackend: true,  hasFrontend: true,  hasTests: true,  hasSSE: false, hasRAG: false, hasAudit: false, hasPermissions: true,  notes: ["ContractorLead CRM", "Tabla leads + stats", "Trust scoring", "Contracts/Payments/Escrow/HelloSign", "52 tests CT.+contractors"] },
  ...
  { name: "Notifications",     hasBackend: true,  hasFrontend: true,  hasTests: true,  hasSSE: true,  hasRAG: false, hasAudit: false, hasPermissions: false, notes: ["SSE dispatch notifications:{tenantId}:{userId}", "NotificationBell header real", "9 new event mappings bid/CO/job/payment/intake/governance", "38 unit tests"] },
  { name: "Trust Scores",      hasBackend: true,  hasFrontend: true,  hasTests: true,  hasSSE: true,  hasRAG: false, hasAudit: false, hasPermissions: true,  notes: ["/admin/trust — score bar, nivel badge, flags", "auto-refresh 30s (SSE-equivalent)", "20 tests TS.L/C/F/UI/CTX"] },
  ...
  { name: "Worker Verification", hasBackend: true, hasFrontend: true,  hasTests: false, hasSSE: false, hasRAG: false, hasAudit: true,  hasPermissions: true,  notes: ["Worker profile: id_document/background_check/phone request UI", "POST /v1/users/:id/verify", "Admin verify button in users table"] },
  // ── ProTools (22 engines + Hub) ──────────────────────────────────────────
  { name: "ProTools Engine",    hasBackend: true,  hasFrontend: true,  hasTests: true,  hasSSE: false, hasRAG: true,  hasAudit: false, hasPermissions: true,  notes: ["26 trade engines at siding-level", "productionSchedule/inspectionGate/priceBands/roi/upsells/warranty", "ToolResultPanel renders all 7 extended sections", "Ollama AI panel on all tools"] },
  // ── Prometeo Civilization Layer (P1-P5) ──────────────────────────────────
  { name: "Trust Passport",     hasBackend: true,  hasFrontend: true,  hasTests: true,  hasSSE: false, hasRAG: false, hasAudit: false, hasPermissions: true,  notes: ["HMAC-SHA256 portable credential", "TrustPassportCard in /admin/users/[id]", "GET /v1/users/:id/trust-passport", "14 unit tests"] },
  { name: "DID Identity",       hasBackend: true,  hasFrontend: true,  hasTests: true,  hasSSE: false, hasRAG: false, hasAudit: false, hasPermissions: false, notes: ["did:semse W3C DID Core", "DID card in /admin/users/[id]", "GET /v1/did/:userId @Public", "17 unit tests"] },
  { name: "Behavioral MCA",     hasBackend: true,  hasFrontend: true,  hasTests: true,  hasSSE: false, hasRAG: false, hasAudit: false, hasPermissions: true,  notes: ["BehavioralHealthSection in ObserverPanel", "trust risk distribution, dispute surge", "GET /v1/ops/behavioral", "18 unit tests"] },
  { name: "DAO Governance",     hasBackend: true,  hasFrontend: true,  hasTests: true,  hasSSE: false, hasRAG: false, hasAudit: false, hasPermissions: true,  notes: ["/admin/governance — ProposalCard, VotingBar, GovernanceFeed", "RBAC: PRO/CLIENT now have governance:read/vote/propose", "24 unit tests"] },
  { name: "Gov Credits",        hasBackend: true,  hasFrontend: true,  hasTests: true,  hasSSE: false, hasRAG: false, hasAudit: false, hasPermissions: true,  notes: ["TrustPassportCard shows credits in /admin/users/[id]", "Participation token ledger 90-day decay", "19 unit tests"] },
];
