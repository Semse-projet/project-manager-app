...
const MODULE_REGISTRY: Array<{
  ...
  { name: "Trust Passport",     hasBackend: true,  hasFrontend: false, hasTests: true,  hasSSE: false, hasRAG: false, hasAudit: false, hasPermissions: true,  notes: ["HMAC-SHA256 portable credential", "GET /v1/users/:id/trust-passport", "POST /v1/trust-passport/verify", "CryptoProfile P6 ready", "14 unit tests"] },
  { name: "DID Identity",       hasBackend: true,  hasFrontend: false, hasTests: true,  hasSSE: false, hasRAG: false, hasAudit: false, hasPermissions: false, notes: ["did:semse W3C DID Core", "GET /v1/did/:userId @Public", "GET /v1/users/me/did", "3 service endpoints in DID Doc", "17 unit tests"] },
  { name: "Behavioral MCA",     hasBackend: true,  hasFrontend: false, hasTests: true,  hasSSE: false, hasRAG: false, hasAudit: false, hasPermissions: true,  notes: ["Human behavior observer — 4th ObservationSnapshot layer", "trust risk distribution, dispute surge, tier distribution", "GET /v1/ops/behavioral", "18 unit tests"] },
  { name: "DAO Governance",     hasBackend: true,  hasFrontend: false, hasTests: true,  hasSSE: false, hasRAG: false, hasAudit: false, hasPermissions: true,  notes: ["Reputation-weighted quadratic voting sqrt(units)*reputationMultiplier", "MCA advice on proposal creation", "6 endpoints POST/GET /v1/governance/proposals", "24 unit tests"] },
  { name: "Gov Credits",        hasBackend: true,  hasFrontend: false, hasTests: true,  hasSSE: false, hasRAG: false, hasAudit: false, hasPermissions: true,  notes: ["Participation token ledger 90-day decay", "Tiers: observer/participant/contributor/steward", "GET /v1/governance/credits/:userId", "19 unit tests"] },
];
