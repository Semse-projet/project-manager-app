...
const MODULE_REGISTRY: Array<{
  ...
  { name: "Trust Scores",      hasBackend: true,  hasFrontend: true,  hasTests: true,  hasSSE: false, hasRAG: false, hasAudit: false, hasPermissions: true,  notes: ["/admin/trust — score bar, nivel badge, flags", "20 tests TS.L/C/F/UI/CTX"] },
  ...
  { name: "SEMSE Agents",      hasBackend: true,  hasFrontend: false, hasTests: true,  hasSSE: false, hasRAG: true,  hasAudit: false, hasPermissions: true,  notes: ["6/6: marketplace+buildops+protools+evidence+crowd+prometeo", "MessageBus + classify/plan/payment-readiness endpoints", "47 tests AG.*"] },
  { name: "Marketplace Bids",  hasBackend: true,  hasFrontend: true,  hasTests: false, hasSSE: false, hasRAG: false, hasAudit: false, hasPermissions: true,  notes: ["BidModal en /client/marketplace — presupuesto+fecha+mensaje", "POST /v1/jobs/:jobId/bids real"] },
];
