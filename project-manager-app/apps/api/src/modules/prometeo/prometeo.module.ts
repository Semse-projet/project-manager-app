...
@Module({
  ...
  providers: [ChunkerService, DocumentParserService, EmbeddingService, PrometeoRepository, PrometeoService],
  exports: [PrometeoService, EmbeddingService, ChunkerService, DocumentParserService],
})
