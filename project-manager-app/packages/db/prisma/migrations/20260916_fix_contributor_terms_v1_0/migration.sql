-- Safe idempotent insert of ContributorTermsVersion v1.0
-- This migration inserts the missing bilingual terms v1.0 row that seed.ts adds but was not run in production.
...
These terms are versioned. A material new version requires new acceptance for future missions. Your acceptance of version 1.0 stays on record even once a version 1.1 or later exists.',
  encode(sha256('# Programa de Contribuidores de Conocimiento SEMSE — Términos v1.0
...
## Actualizaciones
Estos términos están versionados. Una nueva versión material requiere una nueva aceptación para futuras misiones. Tu aceptación de la versión 1.0 permanece registrada incluso si en el futuro existe una versión 1.1 o posterior.' || '# SEMSE Knowledge Contributor Program — Terms v1.0
...
## Updates
These terms are versioned. A material new version requires new acceptance for future missions. Your acceptance of version 1.0 stays on record even once a version 1.1 or later exists.'), 'hex'),
  true,
  now()::timestamp
