...
| SDD/Blueprint Engine | Implementado/parcial | 98 specs; strict 0/0; templates SDD 2.0; estados code/CI/merge/deploy/activation separados | Migrar specs al tocarlas y cerrar evidencia de producción |
