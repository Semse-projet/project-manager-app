...
domain: "ui"
plan: "docs/specs/ui/mobile-admin-trust.plan.md"
version: "1.0"
status: "IN_PROGRESS"
...
# Tareas: Mobile Admin Trust — Fase 7f de apps/mobile
...
- [x] [T-010] `AdminTrustScreen.test.tsx` escrito.
...
- [x] [T-032] UI implementada: `src/api/trust.ts`, `AdminTrustScreen.tsx`,
      `AdminTabNavigator.tsx` (tab `Trust` agregado), `types.ts`.
...
- [ ] [T-053] Resolver review sin ampliar scope (resistir agregar
      trust-passport o cualquier acción mutante).
...
- [ ] [T-061] Smoke autenticado real con cuenta `OPS_ADMIN` real: ver
      trust scores existentes de más de una org, filtrar por nivel,
      confirmar conteos.
