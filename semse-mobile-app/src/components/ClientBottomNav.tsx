...
import { Home, FolderOpen, PlusCircle, MessageCircle, User } from 'lucide-react';
const tabs = [
  { id: 'inicio', label: 'Inicio', icon: Home, path: '/' },
  { id: 'proyectos', label: 'Proyectos', icon: FolderOpen, path: '/cliente/trabajos' },
